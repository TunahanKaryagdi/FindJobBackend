...
namespace FindJob.Persistence.Migrations
{
    ...
    [Migration("20231117132741_name_surname_column_added")]
    partial class name_surname_column_added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FindJob.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CategoryJob", b =>
                {
                    b.HasOne("FindJob.Domain.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FindJob.Domain.Entities.Job", null)
                        .WithMany()
